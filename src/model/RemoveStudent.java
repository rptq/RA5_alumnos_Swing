...
public class RemoveStudent extends javax.swing.JFrame {
    ...
    private void jBttnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBttnDeleteActionPerformed
        for (var student : students) {
            if (jTextField1.getText().equalsIgnoreCase(student.getDni())) {
                students.remove(student);
                jLblMessage.setText("Estudiante eliminado");
                try {
                    FileWriter fw = new FileWriter(registerFile);

                    BufferedWriter bw = new BufferedWriter(fw);

                    for (var studentw : students) {
                        bw.write(studentw.tostringFormat());
                    }
